package com.example.gestionconference.Services.ParticipantServices;
...
public class ParticipantServices {
    ...
    public Participant searchByName(String name) throws SQLException{
        String sql = "SELECT `nom`, `cin`, `dateN`, `numTel`, `email` FROM `participant` WHERE LOWER(`nom`) = LOWER(?)";
        try (PreparedStatement preparedStatement = connection.prepareStatement(sql)) {
